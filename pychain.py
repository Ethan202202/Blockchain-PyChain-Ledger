...
# `amount` attributes
Record_data = Record(sender="Amazon",receiver="Me" , amount = 50 )
...
sender = st.text_input("Sender",key="1")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = st.text_input("Receiver",key="2")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount = st.text_input("Amount",key="3")
